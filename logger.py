...
def input_data():
    ...
    var = int(input(f"В каком формате Вы хотите записать данные (1 или 2): ?\n\n"
                    f"1 Вариант:\n\n"
                    f"{surname}\n"
                    f"{name}\n"
                    f"{phone}\n"
...
def put_data():
    print('Из какого файла Вы хотите изменить данные (1 или 2): ?')
    data_first, data_second = print_data()
    number_file = int(input('Введите номер файла(1 или 2): '))
